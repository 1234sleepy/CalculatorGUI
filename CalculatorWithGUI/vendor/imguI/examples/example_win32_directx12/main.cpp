...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        if (ImGui::Begin("Basic Calculator", &bOpened, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove))
        {
        ...
        if (ImGui::Begin("Quadratic Calculator", &bOpened, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove))
        {
        ...
        if (ImGui::Begin("Trig Calculator", &bOpened, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove))
        {
